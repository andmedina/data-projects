...
values
    ...
    ('imaging_study_series_mismatches', 'ImagingStudy declared series count that does not reconcile to normalized series', 'reconciliation', 'error', 0),
    ('imaging_study_instance_mismatches', 'ImagingStudy declared instance count that does not reconcile to normalized series totals', 'reconciliation', 'error', 0),
    ('imaging_series_missing_modality', 'Normalized imaging series without a DICOM modality code', 'completeness', 'error', 0),
