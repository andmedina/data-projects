...
- `DE-010` Metadata-only FHIR ImagingStudy header/series normalization and reconciliation
- `DE-011` Platform CI, migration, observability, contract, and performance hardening
